	...
	return (
			<Form onSubmit={props.handleSubmit}>
				<Form.Group controlId="formBasicEmail" >
					...
					<Field name="email" component={Text} type="text" placeholder="Login"
						validate = {[required, email, maxLength30]}
						/>
				</Form.Group>
				<Form.Group controlId="formBasicPassword">
					<Form.Label><b>Password</b></Form.Label>
					<Field name="password" component={Text} type="password" placeholder="Password"
					validate = {[required, maxLength30]} />
				</Form.Group>
				<Form.Group controlId="formBasicCheckbox" className={props.checkbox}>
					<Field name="rememberMe" component={Text} type="checkbox"
							 />
