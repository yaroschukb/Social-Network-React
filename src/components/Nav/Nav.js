...
import OnlineContainer from './Online/OnlineContainer.jsx';
...
const Nav = (props) => {
	...
	<nav className = {style.nav}>
      ...
      <div className={`${style.item} ${style.active}`}><NavLink to="/Dialogs" activeClassName={style.active}>Message</NavLink></div>
      ...
      <div className={style.item}><About className={style.modalWindow}
